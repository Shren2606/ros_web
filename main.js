...
var app = new Vue({
    ...
    methods: {
        ...
        saveMap: function () {
            ...
            // Lưu reference của đối tượng để sử dụng trong phạm vi hàm setTimeout
            var self = this;

            // Delay 3 giây trước khi kết thúc các subprocess
            setTimeout(function () {
                // Tạo message để kết thúc các subprocess
                self.killMessage = new ROSLIB.Message({
                    data: '10'
                });

                // Publish message để kết thúc các subprocess
                self.publisher.publish(self.killMessage);
            }, 4000);
        },
